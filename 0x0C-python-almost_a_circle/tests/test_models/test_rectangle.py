#!/usr/bin/python3
"""In this module we define unittests for rectangle.py."""
import unittest
import io
import sys
...
class TestRectangle_instantiation(unittest.TestCase):
    """Unittests for initializing of Rectangle class."""
    ...
    def str_arg(self):
        with self.assertRaises(TypeError):
            Rectangle(10, 2, 16, "Python")
            Rectangle(10, 2, 16, "Best", "Python")
...
class TestRectangle_width(unittest.TestCase):
    """Unittests for initialization of Rectangle width attribute."""
    def width_none(self):
        with self.assertRaises(TypeError):
    ...
    def width_dict(self):
        with self.assertRaises(TypeError):
            Rectangle({'a': 12, 'b': "Python"}, 2, 5, 7, 4)

    def width_tuple(self):
        with self.assertRaises(TypeError):
            Rectangle(("Python", ["Hello", "Wolrd", 3, 5],
                      {'a': 12, 'b': "Python"}), 2, 5, 7, 78)

    def width_list(self):
        with self.assertRaises(TypeError):
            Rectangle(['Hello', 'Wolrd', 3, 5, "Python"], 2, 5, 7, 90)
...
class TestRectangle_height(unittest.TestCase):
    ...
    def height_dict(self):
        with self.assertRaises(TypeError):
            Rectangle(5, {'a': 12, 'b': "Python"}, 5, 7, 4)

    def height_tuple(self):
        with self.assertRaises(TypeError):
            Rectangle(80, ("Python", ["Hello", "World", 3, 5],
                      {'a': 12, 'b': "Python"}), 5, 7, 78)

    def height_list(self):
        with self.assertRaises(TypeError):
            Rectangle(66, ['Hello', 'World', 3, 5, "Python"], 5, 7, 90)
...
class TestRectangle_x(unittest.TestCase):
    ...
    def x_arg(self):
        r = Rectangle(17, 11, 0, 1, "Python")
        self.assertEqual(r.x, 0)

    def x_str(self):
        with self.assertRaises(TypeError):
            Rectangle(5, 6, "Python", 0, 1)
    ...
    def x_dict(self):
        with self.assertRaises(TypeError):
            Rectangle(5, 7, {'a': 12, 'b': "Python"}, 5, 4)

    def x_tuple(self):
        with self.assertRaises(TypeError):
            Rectangle(80, 6, ("Python", ["Hello", "World", 3, 5],
                      {'a': 12, 'b': "Python"}), 7, 78)

    def x_list(self):
        with self.assertRaises(TypeError):
            Rectangle(66, 56, ['Hello', 'World', 3, 5, "Python"], 7, 90)
...
class TestRectangle_y(unittest.TestCase):
    ...
    def y_arg(self):
        r = Rectangle(17, 11, 1, 775, "Python")
    ...
    def y_dict(self):
        with self.assertRaises(TypeError):
            Rectangle(5, 7, 54, {'a': 12, 'b': "Python"}, 4)

    def y_tuple(self):
        with self.assertRaises(TypeError):
            Rectangle(80, 6, 653, ("Python", ["Hello", "World", 3, 5],
                      {'a': 12, 'b': "Python"}), 78)

    def y_list(self):
        with self.assertRaises(TypeError):
            Rectangle(66, 56, 54, ['Hello', 'World', 3, 5, "Python"], 90)
...
class TestRectangle_id(unittest.TestCase):
    ...
    def id_dict(self):
        r = Rectangle(3, 2, 5, 7, {'a': 12, 'b': "Python"})
        self.assertEqual({'a': 12, 'b': "Python"}, r.id)

    def id_tuple(self):
        r = Rectangle(3, 2, 5, 7, ("Python", ["Hello", "World", 3, 5],
                      {'a': 12, 'b': "Python"}))
        self.assertEqual(("Python", ["Hello", "World", 3, 5],
                          {'a': 12, 'b': "Python"}), r.id)

    def id_list(self):
        r = Rectangle(3, 2, 5, 7, ['Hello', 'World', 3, 5, "Python"])
        self.assertEqual(['Hello', 'World', 3, 5, "Python"], r.id)


class TestRectangle_area(unittest.TestCase):
    """Unittests for area of the Rectangle class."""
...
class TestRectangle_update_args(unittest.TestCase):
    ...
    def test_update_args_str_x_y(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaises(TypeError):
            r.update(89, 5, 4, "Hello", "Python")

    def test_update_args_str_all(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaises(TypeError):
            r.update("Hello", "C", "Python", "JSON")


class TestRectangle_update_kwargs(unittest.TestCase):
    """Unittests for update kwargs method of the Rectangle class."""
...
class TestRectangle_update_errors_kwargs(unittest.TestCase):
    """Unittests for update errors kwargs of Rectangle class."""
    ...
    def test_update_height_dict(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaises(TypeError):
            r.update(height={'a': "b", 'c': 24},
                     id=2, width=4, y=6)

    def test_update_height_list(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaises(TypeError):
            r.update(height=["Best", 24, "com"],
                     id=2, width=4, y=6)
    ...
    def test_update_y_list(self):
        r = Rectangle(10, 10, 10, 10, 10)
        with self.assertRaises(TypeError):
            r.update(y=["Best", 24, "com"],
                     id=2, width=4, x=6, height=30)


class TestRectangle_to_dictionary(unittest.TestCase):
    """Unittests for dictionary for rectangle class."""
