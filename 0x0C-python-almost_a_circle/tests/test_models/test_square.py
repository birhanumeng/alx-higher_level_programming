#!/usr/bin/python3
"""In this model we define unittests for square.py."""
import unittest
import io
import sys
...
class TestSquare_instantiation(unittest.TestCase):
    """Unittests for instantiation of the Square class."""
    ...
    def test_id_str(self):
        self.assertEqual("Python", Square(1, 2, 6, "Python").id)
    ...
    def test_six_arg(self):
        with self.assertRaises(TypeError):
            Square(10, 2, 16, 4, 4, "Python")


class TestSquare_size(unittest.TestCase):
    """Unittests for initializing of Square size attribute."""
...
class TestSquare_x(unittest.TestCase):
    """Unittests for initializing of Square x attribute."""
...
class TestSquare_y(unittest.TestCase):
    """Unittests for initializing of Square y attribute."""
...
class TestSquare_id(unittest.TestCase):
    """Unittests for initializing of Square id attribute."""
...
class TestSquare_order_of_initialization(unittest.TestCase):
    """Unittests for order of Square attribute initialization."""
...
class TestSquare_stdout(unittest.TestCase):
    """Unittests for display methods of Square class."""
...
class TestSquare_update_args(unittest.TestCase):
    """Unittests for update args method of the Square class."""
...
class TestSquare_update_kwargs(unittest.TestCase):
    """Unittests for update kwargs method of Square class."""
...
class TestSquare_to_dictionary(unittest.TestCase):
    """Unittests for dictionary method of the Square class."""
