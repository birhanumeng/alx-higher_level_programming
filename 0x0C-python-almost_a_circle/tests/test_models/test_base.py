#!/usr/bin/python3
"""In this model we implement unittests for base.py."""
import unittest
import os
import json
import sys
...
class TestBase_instantiation(unittest.TestCase):
    ...
    def test_str(self):
        ...
        b_string = Base("Python")
        self.assertEqual(b_string.id, "Python")

    def test_dict_id(self):
        b_dict = Base({'a': 12, 'b': "Python"})
        self.assertEqual(b_dict.id, {'a': 12, 'b': "Python"})

    def test_tuple_id(self):
        b_tuple = Base(("Python", ["Hello", "World", 3, 5],
                       {'a': 12, 'b': "Python"}))
        self.assertEqual(b_tuple.id, ("Python", ["Hello", "World", 3, 5],
                         {'a': 12, 'b': "Python"}))

    def test_list_id(self):
        b_list = Base(['Hello', 'World', 3, 5, "Python"])
        self.assertEqual(b_list.id, (['Hello', 'World', 3, 5, "Python"]))
...
class TestBase_save_to_file(unittest.TestCase):
    """Unittests for save to file method of Base class."""
...
class TestBase_from_json_string(unittest.TestCase):
    """Unittests for from json string method of Base class."""
    ...
    def test_load_from_file(self):
        """Test load from file with not exist"""
    ...
    def test_to_json_string_empty(self):
        """Test inherited to json_string with empty and None"""
        self.assertEqual(Base.to_json_string([]), '[]')
        self.assertEqual(Base.to_json_string(None), '[]')
