#!/usr/bin/python3
"""In this module we create base class."""
import json
from os import path
...
class Base(object):
    ...
    def to_json_string(list_dict):
        """Converts python list of dictionary to JSON"""
    ...
    def from_json_string(json_string):
        """Returns JSON string representation json string"""
    ...
    def create(cls, **dictionary):
        """Returns an instance and its attributes in set"""
